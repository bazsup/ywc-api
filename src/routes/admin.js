...
router.get('/', adminAuthen(ROLE_ADMIN), async (req, res, next) => {
  try {
...
router.post('/', adminAuthen(ROLE_ADMIN), async (req, res, next) => {
...
router.delete('/:id', adminAuthen(ROLE_ADMIN), async (req, res, next) => {
  try {
